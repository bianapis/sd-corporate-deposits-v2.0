...
@BianRestController
public class CorporateDepositsApiController {

	@Autowired
	CorporateDepositsApiService service;
	
	@Fulfill.Activate
	public BianResponse<SDCorporateDepositsActivateOutputModel> activate(@RequestBody BianRequest<SDCorporateDepositsActivateInputModel> bianRequest) {
		return BianResponse.forSuccess(service.activate(bianRequest.getData()));
	}
	
	@Fulfill.Configure
	public BianResponse<SDCorporateDepositsConfigureOutputModel> configure(@PathVariable("sd-reference-id") String sdReferenceId, @RequestBody BianRequest<SDCorporateDepositsConfigureInputModel> bianRequest) {
		return BianResponse.forSuccess(service.configure(sdReferenceId, bianRequest.getData()));
	}
	
	@Fulfill.Control
	public BianResponse<CRCorporateDepositsFulfillmentArrangementControlOutputModel> control(@PathVariable("sd-reference-id") String sdReferenceId, @PathVariable("cr-reference-id") String crReferenceId, @RequestBody BianRequest<CRCorporateDepositsFulfillmentArrangementControlInputModel> bianRequest) {
	...
	@Fulfill.Feedback
	public BianResponse<SDCorporateDepositsFeedbackOutputModel> feedback(@PathVariable("sd-reference-id") String sdReferenceId, @RequestBody BianRequest<SDCorporateDepositsFeedbackInputModel> bianRequest) {
		return BianResponse.forSuccess(service.feedback(sdReferenceId, bianRequest.getData()));
	}
	
	@Fulfill.Initiate
	public BianResponse<CRCorporateDepositsFulfillmentArrangementInitiateOutputModel> initiate(@PathVariable("sd-reference-id") String sdReferenceId, @RequestBody BianRequest<CRCorporateDepositsFulfillmentArrangementInitiateInputModel> bianRequest) {
	...
	@Fulfill.Retrieve
	public BianResponse<CRCorporateDepositsFulfillmentArrangementRetrieveOutputModel> retrieve(@PathVariable("sd-reference-id") String sdReferenceId, @PathVariable("cr-reference-id") String crReferenceId) {
	...
	@Fulfill.RetrieveSD
	public BianResponse<SDCorporateDepositsRetrieveOutputModel> retrieveSD(@PathVariable("sd-reference-id") String sdReferenceId) {
		return BianResponse.forSuccess(service.retrieveSD(sdReferenceId));
	}
	
	@Fulfill.Update
	public BianResponse<CRCorporateDepositsFulfillmentArrangementUpdateOutputModel> update(@PathVariable("sd-reference-id") String sdReferenceId, @PathVariable("cr-reference-id") String crReferenceId, @RequestBody BianRequest<CRCorporateDepositsFulfillmentArrangementUpdateInputModel> bianRequest) {
